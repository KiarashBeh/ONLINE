...
exec msdb.dbo.TC_pGenerate_DB_User_Permissions_v4 'BI_SalesForce';

if exists(select 1 from sys.sysprocesses where  DB_NAME(dbid) = 'BI_SalesForce')
BEGIN
exec msdb..TC_pKill_DB_Sessions  @databaseName=  'BI_SalesForce'
END

-------------- steg ---------------  2 -------------------


exec msdb.dbo.pTC_Restore_Database_From_Prod_v4  @database_name = N'BI_SalesForce' 
...
GO
DECLARE @dbName nvarchar(250) = 'BI_SalesForce'
set nocount on;
