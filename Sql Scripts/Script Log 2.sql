...
exec msdb.dbo.TC_pGenerate_DB_User_Permissions_v4 'BI_PWC_Log';

if exists(select 1 from sys.sysprocesses where  DB_NAME(dbid) = 'BI_PWC_Log')
BEGIN
exec msdb..TC_pKill_DB_Sessions  @databaseName=  'BI_PWC_Log'
END

-------------- steg ---------------  2 -------------------


exec msdb.dbo.pTC_Restore_Database_From_Prod_v4  @database_name = N'BI_PWC_Log' 
...
GO
DECLARE @dbName nvarchar(250) = 'BI_PWC_Log'
set nocount on;
